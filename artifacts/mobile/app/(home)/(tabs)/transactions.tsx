...
const SOURCE_OPTIONS = ["manual", "amex", "chase"] as const;
...
function QuickAddModal(props: {
  ...
  const submit = async () => {
    ...
    const signed = (kind === "expense" ? -parsed : parsed).toFixed(2);
    try {
          ...
          <ScrollView keyboardShouldPersistTaps="handled">
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                >
                  Counts toward this week's spending.
                </Text>
              </View>
              <Switch
            ...
            {error && (
              <Text
                style={[modalStyles.error, { color: colors.destructive }]}
              >
                {error}
              </Text>
            )}
