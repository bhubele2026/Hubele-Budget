...
describe("forecast schedule stability", () => {
  ...
  it("keeps quarterly month-end dates anchored after a short month", () => {
    const out = expandItem(item({ id: "q", name: "Quarterly", frequency: "quarterly", anchorDate: "2026-01-31" }), new Date(2026, 0, 1), new Date(2026, 11, 31));
  ...
  it("restores leap-day anniversaries after non-leap years", () => {
    const out = expandItem(item({ id: "a", name: "Annual", frequency: "annual", anchorDate: "2024-02-29" }), new Date(2025, 0, 1), new Date(2028, 11, 31));
  ...
  it("returns identical occurrences when the visible window changes", () => {
    const row = item({ id: "q", name: "Quarterly", frequency: "quarterly", anchorDate: "2026-01-31" });
