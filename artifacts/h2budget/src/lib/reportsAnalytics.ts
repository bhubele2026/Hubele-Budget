...
// -- Budget ------------------------------------------------------------------
// (#854 Phase 2) The Budget tab now renders from the server-side budgetFacts
// pipeline (GET /reports/budget-facts). The old client-side helpers
// (budgetVariance / budgetBurndown / budgetConsistencyHeatmap /
// perCategoryBurndown) were removed when the tab was rebuilt class-aware.
