...
function KillRow({ card }: { card: AmexWeeklyPayoffCard }) {
  ...
  return (
    <Link
      ...
      className="group flex items-center gap-4 rounded-lg border border-card-border bg-card px-4 py-3 transition-colors hover:border-primary/40 hover:bg-accent/40"
