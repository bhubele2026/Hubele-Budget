...
// POST /budget/seed-bills is gone (2026-09-15, owner decision). It topped up
// the seed bills by name, so it re-added bills the household had deleted.
// Starter bills now come only from seedDefaultsOnce, once per household.
