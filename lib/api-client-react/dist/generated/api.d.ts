 ...
 */
export declare const getGetForecastBankBalanceExplainUrl: () => string;
export declare const getForecastBankBalanceExplain: (options?: RequestInit) => Promise<GetForecastBankBalanceExplain200>;
export declare const getGetForecastBankBalanceExplainQueryKey: () => readonly ["/api/forecast/bank-balance-explain"];
export declare const getGetForecastBankBalanceExplainQueryOptions: <TData = Awaited<ReturnType<typeof getForecastBankBalanceExplain>>, TError = ErrorType<unknown>>(options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof getForecastBankBalanceExplain>>, TError, TData>;
    request?: SecondParameter<typeof customFetch>;
}) => UseQueryOptions<Awaited<ReturnType<typeof getForecastBankBalanceExplain>>, TError, TData> & {
    queryKey: QueryKey;
};
export type GetForecastBankBalanceExplainQueryResult = NonNullable<Awaited<ReturnType<typeof getForecastBankBalanceExplain>>>;
export type GetForecastBankBalanceExplainQueryError = ErrorType<unknown>;
export declare function useGetForecastBankBalanceExplain<TData = Awaited<ReturnType<typeof getForecastBankBalanceExplain>>, TError = ErrorType<unknown>>(options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof getForecastBankBalanceExplain>>, TError, TData>;
    request?: SecondParameter<typeof customFetch>;
}): UseQueryResult<TData, TError> & {
    queryKey: QueryKey;
...
export declare const getSpine: (options?: RequestInit) => Promise<Spine>;
export declare const getGetSpineQueryKey: () => readonly ["/api/spine"];
export declare const getGetSpineQueryOptions: <TData = Awaited<ReturnType<typeof getSpine>>, TError = ErrorType<unknown>>(options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof getSpine>>, TError, TData>;
    request?: SecondParameter<typeof customFetch>;
}) => UseQueryOptions<Awaited<ReturnType<typeof getSpine>>, TError, TData> & {
    queryKey: QueryKey;
};
export type GetSpineQueryResult = NonNullable<Awaited<ReturnType<typeof getSpine>>>;
export type GetSpineQueryError = ErrorType<unknown>;
/**
 * @summary One shared snapshot of the household's core numbers (the spine)
 */
export declare function useGetSpine<TData = Awaited<ReturnType<typeof getSpine>>, TError = ErrorType<unknown>>(options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof getSpine>>, TError, TData>;
    request?: SecondParameter<typeof customFetch>;
}): UseQueryResult<TData, TError> & {
    queryKey: QueryKey;
