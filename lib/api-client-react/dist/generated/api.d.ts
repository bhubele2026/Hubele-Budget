...
export declare const updateRecurringItem: (id: string, recurringItemInput: RecurringItemInput, options?: RequestInit) => Promise<UpdateRecurringItemResponse>;
...
export declare const getForecastBankBalanceExplain: (options?: RequestInit) => Promise<BankBalanceExplain>;
